...
<h2>✨ 느낀점</h2>
📌 시작 전: 걱정 반 설렘 반🧑‍🤝‍🧑<br>
 생각보다 적은 인원으로 시작하는 프로젝트였기에 사이트의 결과물이 제대로 나올 수 있을지 걱정을 하지 않을 수 없었습니다, 개발 시작 전, 세명이 단기간에 완성도를 높일 수 있을 지, 혹여나 구현을 못할 페이지가 있진 않은지 걱정 반, 설렘 반으로 기획을 검토했습니다.<br><br>
📌 진행 중: 열쩡열쩡✨<br>
 ...
 개인적으로는 이번 장고 프로젝트에서 처음으로 결제 서비스와 구글맵 서비스를 진행해보았습니다. 지난 스프링 프로젝트에서 메일 api는 사용해본 적이 있었지만 사용법을 정확히 아는 상태에서 프로젝트에 적용하는 것 이었기에 어려움이 없었지만, 이번 결제와 구글맵 api는 직접 코드를 찾아보며 적용을 해야하는 부분이라 새롭게 다가왔습니다. 다른 사람의 코드를 읽으며 내 프로젝트에 적용하는 과정에서 한층 성장할 수 있었습니다.<br><br>
📌 미래: 발전가능성🕰️<br>
