...
const replyService = (function(){
    async function getList(){
        const response = await fetch(`/event/replies/list/${post_id}/${page}`);
        const replies = await response.json()
        return replies;
    }
    async function write(reply_content){
        const response = await fetch("/event/replies/write/", {
            method: 'post',
    ...
    async function modify(id, reply_content){
        const response = await fetch("/event/replies/modify/", {
            method: 'post',
            headers: {'Content-Type': 'application/json; charset=utf-8'},
    ...
    async function remove(id){
        const response = await fetch(`/event/replies/delete/${id}`, {
            method: 'get',
            headers: {'Content-Type': 'application/json; charset=utf-8'},
        });
        // response.catch((error) => {})
...
function checkLike(){
    ...
    fetch(`/event/likes/exist/${post_id}`, {
        method: 'get',
        headers: {'Content-Type': 'application/json; charset=utf-8'},
    }).then((response)=> response.json())
        .then((check) => {
