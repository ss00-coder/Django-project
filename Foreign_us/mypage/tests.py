...
class Lesson(TestCase):
    ...
    Lesson.objects.bulk_create([
        ...
        Lesson(post_title='일본어', post_content='일본어과외',post_view_count=142, post_status='Y', member_id=2),
        Lesson(post_title='중국어', post_content='중국어과외', post_view_count=24, post_status='N', member_id=3),
        ...
        Lesson(post_title='일본어', post_content='일본어과외', post_view_count=122, post_status='Y', member_id=5),
