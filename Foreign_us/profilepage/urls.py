...
urlpatterns = [
    ...
    path('review/<int:member_id>/<int:page>', ProfileReviewListAPI.as_view(), name='review-list'),
    path('lesson/<int:member_id>/<int:page>', ProfileLessonListAPI.as_view(), name='lesson-list'),
